...
function css_reminder_menu_page() {
	...
	<div class="welcome-panel">
		<div class="welcome-panel-content">
			...
			<p><?php esc_html_e( 'I hope you have found this plugin helpful. It has saved me a lot of time when changing themes or migrating websites.', 'css-reminder' ); ?><br></p>
			<p><a href="https://wordpress.org/support/plugin/css-reminder/reviews/#new-post"><?php esc_html_e( 'If you like the plugin, please rate it on WordPress.org', 'css-reminder' ); ?></a></p>
		</div>
	</div>
	</div>
	<?php
